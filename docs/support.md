...
| `oneOf`; `anyOf`; conditional schemas | No complete branch analysis; Encoding keys may still name properties declared in alternatives | Do not depend on automatic media inference; provide explicit media/encoding and a whole-body extension where necessary |
