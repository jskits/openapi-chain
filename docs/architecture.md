...
The transitive ESM core is gzip-gated at 2048 bytes. The size script recursively follows local ESM imports from `dist/index.js`, gzips the complete reachable runtime, and fails CI on regression.
