...
- **Small default runtime:** the complete emitted core has a **3KB gzip budget**, enforced by a [reproducible size check](https://github.com/jskits/openapi-chain/blob/main/docs/performance.md#size).
